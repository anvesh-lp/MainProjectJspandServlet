...
<%--            <td><label class="namei" type="text" placeholder="Enter Students name" name="id" value="${location.getId()}" readonly></td>--%>
        ...
        <td><input class="namei" type="text"  name="desg" value="${designation.getDesignation()}" required="required"></td>
        </tr>

        <td>
            <label >City</label>
        </td>
        <td><input class="namei" type="salary" name="salary" value="${designation.getSalary()}" required="required"></td>
        </tr>
        <%--<tr>
            <td>
                <label >Street</label>
