...
<div class="center">
    ...
    <table class="center">
        ...
        <tr>
            ...
            <td><input class="namei" type="text" placeholder="Enter Students name" name="id" required="required"></td>
        </tr>

        <td>
            <label >ZipCode</label>
        </td>
        <td><input class="namei" type="number" placeholder="Enter Students name" name="code" required="required"></td>
        </tr>
