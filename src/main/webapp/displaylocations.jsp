...
<div id="main">
    ...
    <div class="header">
        ...
        <div class="header-right">
            <a class="active" href="add_location.jsp">Add Location</a>
                        ...
                        <tr>
                            ...
                            <td id="update">
                                <div class="update"><input type="button" value="Update"
                                                           onclick="window.location.href='LocationInfoManagement?command=LOAD&locationID=${st.getId()}';
return false;" class="updatebt"/></div>
                            </td>
                            <td id="delete">
                                <div class="delete"><input type="button" value="Delete"
                                                           onclick="if(!display()) return false; window.location.href='LocationInfoManagement?command=DELETE&locationID=${st.getId()}';
                                                       return false;"
                                                           class="deletebt"/>
                                </div>
                            </td>
