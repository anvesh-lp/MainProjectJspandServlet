    ...
    <form action="LocationInfoManagement" method="get">
        ...
        <table class="center">
            ...
            <tr>
                ...
                <td><label>
                    <input class="namei" type="text" placeholder="Enter Students name" name="id"
                           value="${location.getId()}" readonly>
                </label></td>
            ...
            <td><input class="namei" type="number" placeholder="Enter Students name" name="code"
                       value="${location.getZipcode()}" required="required"></td>
            </tr>

            <td>
                <label>City</label>
            </td>
            <td><input class="namei" type="text" placeholder="Enter Students name" name="city"
                       value="${location.getCity()}" required="required"></td>
            </tr>
            <tr>
                <td>
                    <label>Street</label>
                ...
                <td><input class="namei" type="text" placeholder="Enter Students Marks" name="street"
                           value="${location.getStreet()}" required="required"></td>
            </tr>
            <tr>
