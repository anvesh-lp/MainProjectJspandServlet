                        ...
                        <tr>
                            ...
                            <td id="update">
                                <div class="update"><input type="button" value="Update"
                                                           onclick="window.location.href='CategorieInfo?command=LOAD&catId=${st.getId()}';
return false;" class="updatebt"/></div>
                            </td>
                            <td id="delete">
                                <div class="delete"><input type="button" value="Delete"
                                                           onclick="if(!display()) return false; window.location.href='CategorieInfo?command=DELETE&catId=${st.getId()}';
                                                       return false;"
                                                           class="deletebt"/>
                                </div>
                            </td>
