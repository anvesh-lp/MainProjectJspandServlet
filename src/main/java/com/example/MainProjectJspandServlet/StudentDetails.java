...
public class StudentDetails extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        try {
            ...
            studentDataBase = new StudentDataBase(ds);
...
//        displayStudents(request,response);
    ...
    private void addStudent(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
//            displayStudents(request,response);
            response.sendRedirect(request.getContextPath() + "/StudentDetails?command=LIST");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void displayStudents(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        List<Student> students = studentDataBase.getstudentsFromDB();
        if (students == null) {
