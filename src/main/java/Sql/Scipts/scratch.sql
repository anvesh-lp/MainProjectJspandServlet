...
values ("JTP01", 413245, "New York", "Jericho"),
       ("NHP02", 413287, "New York", "Hyde Park"),
       ("WGP03", 417654, "Pennsylvania", "Willow Grove");


create table designation
(
    Dsgn_Id     varchar(20) not null,
...
values ("AM01", "Asst.Manager", 80000),
       ("LVL1", "Level 1", 70000),
       ("M01", "Manager", 100000);
...
insert into designation
values ("SM01", "Senior Manager", 140000),
       ("CSH01", "cashier", 50000),
...
insert into employees
values ("ATA09", "raczeen@gail.com", "9432187654", "Rachel", "Zeen", 316532, "M01"),
...
values (1, 'Shane', 'Lane', 5679345679, "shane.l@gmail.com", "JTP01"),
...
insert into Manager(E_Id, Mobile, Email)
select E_Id, Mobile, Email
from employees
where Dsgn_Id = "M01";
...
insert into DBUsers(E_Id, Username, Password)
select E_Id, substring(Email, 1, 6), SHA1(substring(E_Id, 1, 6))
from Manager;
...
(
    Supplier_No      int            NOT NULL Primary Key AUTO_INCREMENT,
    Supplier_Name    varchar(20)    NOT NULL,
    Mobile           varchar(20)    NOT NULL,
    Location_Id      varchar(20)    NOT NULL,
    Email            varchar(30)    not null,
    Product_No       int            NOT NULL,
    FOREIGN KEY (Product_No) REFERENCES Commodities (Product_No),
    foreign key (Location_Id) references location (Location_Id),
...
values (1, 'Panera', 7654532879, "JTP01", "panera@gmail.com", 4, 2),
